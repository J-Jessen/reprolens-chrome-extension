...
1. Open the private [v0.8.0-beta.4 release](https://github.com/J-Jessen/behavior-trace-chrome-extension/releases/tag/v0.8.0-beta.4).
2. Download `behaviour-tracer-v0.8.0-beta.4.zip` from **Assets**. Do not download GitHub's automatic source archive.
