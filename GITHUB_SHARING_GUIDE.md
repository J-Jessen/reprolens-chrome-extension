...
1. Open the private [v0.9.0-beta.3 release](https://github.com/J-Jessen/behavior-trace-chrome-extension/releases/tag/v0.9.0-beta.3).
2. Download `behaviour-tracer-v0.9.0-beta.3.zip` from **Assets**. Do not download GitHub's automatic source archive.
