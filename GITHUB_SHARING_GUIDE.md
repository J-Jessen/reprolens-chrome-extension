...
1. Open the private [v0.7.0-beta.2 release](https://github.com/J-Jessen/behavior-trace-chrome-extension/releases/tag/v0.7.0-beta.2).
2. Download `behaviour-tracer-v0.7.0-beta.2.zip` from **Assets**. Do not download GitHub's automatic source archive.
